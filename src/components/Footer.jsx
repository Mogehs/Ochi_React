...
function Footer() {
  return (
    <>
      <div className=" relative w-full min-h-[80vh] bg-[#F1F1F1] p-[4.5vw] flex justify-between  rounded-t-2xl msm:max-md:flex-col msm:max-md:justify-start -mt-2">
        <div className="left w-1/2 h-full  text-[#212121] font-[Impact] text-[9vw] font-light uppercase leading-none msm:max-md:h-32">
          Eye- Opening
        </div>
        <div className="relative w-1/2 h-full  text-[#212121] font-[Impact] text-[8vw] font-light uppercase leading-none ">
          Presentations
        </div>
      </div>
      <div className="w-full bg-[#F1F1F1] text-[#212121] px-[10vw] py-[1vw] relative bottom-0 flex justify-between gap-2 items-center">
        <svg
        ...
        &copy; R* Design _ All Rights Are Reserved
      </div>
    </>
  );
}
