...
function Footer() {
  return (
    <>
      <div className="w-full min-h-[100vh] rounded-xl bg-[#F1F1F1] p-[2vw] flex  flex-col justify-between">
        <div className=" relative [w-100vw]  flex  rounded-t-2xl flex-col justify-start lg:flex-row lg:justify-between ">
          <div className="left w-[12px]  text-[#212121] font-founder text-[4rem] md:text-[8rem] md:w-[10rem] font-light uppercase leading-[2.8rem] md:leading-[5.5rem] lg:leading-[5.5rem] ">
            Eye-Opening
          </div>
          <div className="relative     text-[#212121] font-founder text-[4rem] md:text-[8rem] font-light uppercase leading-[2.8rem] md:leading-[5.5rem]    lg:leading-[5.5rem] ">
            Presentations
          </div>
        </div>
        <div className="w-full bg-[#F1F1F1] text-[#212121] relative bottom-0 flex gap-10 items-baseline">
          <svg
            className="text-[#212121] mb-1"
            width="72"
            height="30"
            viewBox="0 0 72 30"
            fill="none"
          ...
          <p className="font-neue font-bold sm:text-[0.5rem]  md:text-[1.1rem]">
            &copy; R* Design _ All Rights Reserved
          </p>
        </div>
      </div>
    </>
